    ...
    <div className="w-full max-w-md relative shadow-2xl shadow-black/5 min-h-screen bg-[#FAFAFA] flex flex-col">
      ...
      <div className="sticky top-0 z-50 bg-[#FAFAFA] border-b border-[#171717]/10">
        <div className="flex items-center justify-between px-6 py-4">
          <div className="flex items-center gap-3">
            ...
            <h1 className="font-serif text-2xl text-[#171717]">프로필 수정</h1>
          </div>
      ...
      <div className="flex-1 overflow-y-auto pb-32"> {/* Increased padding bottom for floating button */}
        <div className="px-6 py-6 space-y-6">
          ...
          <div className="bg-white border border-[#171717]/10 rounded-xl p-5 shadow-sm">
            <div className="flex items-center justify-between mb-4">
              <h3 className="font-serif text-lg text-[#171717]">프로필 사진</h3>
              <span className="text-xs text-[#171717]/60 font-sans">
            ...
            <div className="grid grid-cols-3 gap-3">
              ...
              {formData.profilePhotos.map((photo, index) => (
                <div key={photo.id} className="relative aspect-square">
                  <div className="w-full h-full rounded-lg overflow-hidden border border-[#171717]/10">
                    <ImageWithFallback
                      src={photo.url}
                      alt={`Profile ${index + 1}`}
                  ...
                  {index === 0 && (
                    <div className="absolute top-1 left-1 bg-[#CC0000] text-white text-xs px-2 py-0.5 rounded font-sans">
                      대표
                    </div>
                  )}
                  <button
                    onClick={() => handleDeletePhoto(photo.id)}
                    className="absolute top-1 right-1 w-6 h-6 bg-[#171717] rounded-full flex items-center justify-center hover:bg-[#171717]/80 transition-colors shadow-md"
                  >
              ...
              {formData.profilePhotos.length < 5 && (
                <button
                  ...
                  className="aspect-square border-2 border-dashed border-[#CC0000] rounded-lg flex flex-col items-center justify-center gap-1.5 hover:bg-[#CC0000]/5 transition-colors"
                >
                  <Plus className="w-6 h-6 text-[#CC0000]" />
                  <span className="text-xs text-[#CC0000] font-sans">추가</span>
                </button>
              )}
            </div>
            ...
            <p className="text-xs text-[#171717]/60 font-sans mt-1 leading-relaxed">
              <span className="text-[#CC0000]">최소 1장</span> 이상, <span className="text-[#CC0000]">최대 5장</span>까지 등록 가능합니다
            </p>
          </div>

          {/* Basic Information */}
          <div className="bg-white border border-[#171717]/10 rounded-xl p-5 shadow-sm">
            <h3 className="font-serif text-lg text-[#171717] mb-4">기본 정보</h3>
            <div className="space-y-4">
              {/* Nickname */}
              <div>
                <label className="block text-xs text-[#171717]/70 font-sans mb-2">
                  닉네임 *
                </label>
                <input
                  type="text"
              ...
              <div>
                ...
                <input
                  ...
                  disabled
                  className="w-full px-4 py-2.5 border border-[#171717]/10 rounded-lg text-[#171717]/40 font-sans text-sm bg-[#171717]/5 cursor-not-allowed"
                />
                <p className="text-xs text-[#171717]/40 mt-1 font-sans">
                  성별은 변경할 수 없습니다
                </p>
              </div>
          ...
          <div className="bg-white border border-[#171717]/10 rounded-xl p-5 shadow-sm">
            <h3 className="font-serif text-lg text-[#171717] mb-4">추가 정보</h3>
            <div className="space-y-4">
              {/* Location */}
              <div>
                <label className="block text-xs text-[#171717]/70 font-sans mb-2">
          ...
          {/* About Me */}
          <div className="bg-white border border-[#171717]/10 rounded-xl p-5 shadow-sm">
            <h3 className="font-serif text-lg text-[#171717] mb-4">자기소개</h3>
            <div className="space-y-4">
              {/* Bio */}
              <div>
                <label className="block text-xs text-[#171717]/70 font-sans mb-2">
                ...
                <textarea
                  ...
                  rows={6}
                  maxLength={500}
                  className="w-full px-4 py-3 border border-[#171717]/20 rounded-lg text-[#171717] font-sans text-sm focus:outline-none focus:border-[#CC0000] transition-colors resize-none bg-white leading-relaxed"
                  placeholder="당신을 표현하는 문장을 작성해주세요..."
                />
                <p className="text-xs text-[#171717]/40 mt-1 font-sans text-right">
          ...
          <div className="bg-[#CC0000]/5 border border-[#CC0000]/20 rounded-lg p-4">
            <p className="text-xs text-[#171717]/70 font-sans leading-relaxed">
              <span className="text-[#CC0000]">*</span> 표시는 필수 입력 항목입니다
            </p>
          </div>
      ...
      <div className="fixed bottom-[70px] left-0 right-0 p-6 bg-gradient-to-t from-[#FAFAFA] via-[#FAFAFA] to-transparent z-50 flex justify-center">
        <div className="w-full max-w-md">
          <button
            ...
            className={`w-full font-sans font-medium py-4 rounded-xl shadow-lg transition-all active:scale-[0.98] disabled:opacity-70 disabled:cursor-not-allowed flex items-center justify-center gap-2 ${isDirty
              ? "bg-[#171717] text-white shadow-[#171717]/20 hover:bg-[#171717]/90"
              : "bg-[#171717]/20 text-[#171717]/40 shadow-none cursor-not-allowed"
              }`}
          >
            {isSaving ? (
              <>
