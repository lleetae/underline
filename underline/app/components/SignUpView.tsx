    ...
    try {
      ...
      const { data: newMember, error } = await supabase
        ...
        .insert({
          ...
          referrer_user_id: (localStorage.getItem('referrer_id') && localStorage.getItem('referrer_id') !== '') ? localStorage.getItem('referrer_id') : null // Add referrer ID, sanitize empty string
        })
        .select()
        .single();
