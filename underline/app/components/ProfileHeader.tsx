...
export function ProfileHeader({
  ...
  return (
    <div className="flex flex-col items-center text-[var(--foreground)] animate-in fade-in duration-700 slide-in-from-bottom-4">
      <div className="w-full max-w-md px-6 pt-4 pb-8">
        ...
        <div className="space-y-2 text-center">
          ...
          <p className="text-sm leading-relaxed opacity-80 font-sans max-w-xs mx-auto text-[var(--foreground)]/90">
            {intro}
          </p>
        </div>
      </div>
