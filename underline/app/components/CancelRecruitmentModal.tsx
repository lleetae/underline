        ...
        <div className="px-6 py-8">
          ...
          <div className="bg-gradient-to-br from-[var(--primary)]/10 to-[var(--primary)]/5 border-2 border-[var(--primary)]/30 rounded-xl p-5 mb-6">
            <div className="flex gap-3">
              ...
              <div>
                <p className="text-sm text-[var(--foreground)] font-sans leading-relaxed mb-3">
          ...
          <div className="flex flex-col gap-3">
            <button
              onClick={onClose}
              className="w-full py-3.5 bg-[var(--primary)] text-white rounded-lg font-sans font-medium hover:bg-[var(--primary)]/90 transition-all duration-300 shadow-lg shadow-[var(--primary)]/30"
            >
              계속 참여하기
            </button>
            <button
              onClick={onConfirm}
              className="w-full py-3 border-2 border-[var(--foreground)]/20 text-[var(--foreground)]/60 rounded-lg font-sans font-medium hover:bg-[var(--foreground)]/5 transition-colors text-sm"
            >
              취소하기
            </button>
          </div>
