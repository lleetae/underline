      ...
      >
        ...
        <div className="px-6 py-8">
          ...
          <div className="bg-gradient-to-br from-[#CC0000]/10 to-[#CC0000]/5 border-2 border-[#CC0000]/30 rounded-xl p-5 mb-6">
            <p className="text-xs text-[#171717] font-sans leading-relaxed mb-2 font-medium">
              💡 <span className="font-medium">알아두세요</span>
            </p>
            <ul className="space-y-1.5 text-xs text-[#171717] font-sans">
          ...
          <div className="flex gap-3">
            <button
              onClick={onClose}
              className="flex-1 py-3.5 bg-[#CC0000] text-white rounded-lg font-sans font-medium hover:bg-[#CC0000]/90 transition-all duration-300 shadow-lg shadow-[#CC0000]/30"
            >
              계속 신청하기
            </button>
            <button
              onClick={onConfirm}
              className="flex-1 py-3.5 border-2 border-[#171717]/20 text-[#171717]/60 rounded-lg font-sans font-medium hover:bg-[#171717]/5 transition-colors"
            >
              취소할게요
            </button>
          </div>
