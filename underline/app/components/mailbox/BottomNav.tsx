...
export function BottomNav({ activeTab, onTabChange }: BottomNavProps) {
  return (
    <div className="fixed bottom-0 left-0 right-0 bg-[#FAFAFA] border-t border-[#C2C2C2]/60 px-6 py-3 z-50 flex justify-center">
      <div className="flex justify-between items-center w-full max-w-md">
        <button 
           onClick={() => onTabChange?.("home")}
           className={cn(
             "flex flex-col items-center gap-1 transition-colors p-2",
             activeTab === "home" ? "text-[#171717]" : "text-[#333333]/35"
           )}
        >
        ...
        <button 
           ...
           className={cn(
             "flex flex-col items-center gap-1 transition-colors p-2",
             activeTab === "mailbox" ? "text-[#171717]" : "text-[#333333]/35"
           )}
        >
        ...
        <button 
           ...
           className={cn(
             "flex flex-col items-center gap-1 transition-colors p-2",
             activeTab === "profile" ? "text-[#171717]" : "text-[#333333]/35"
           )}
        >
