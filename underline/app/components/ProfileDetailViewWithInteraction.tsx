...
export function ProfileDetailViewWithInteraction({
  ...
  if (isLoading) {
    return (
      <div className="w-full max-w-md relative shadow-2xl shadow-black/5 h-full bg-[#FAFAFA] flex items-center justify-center">
        <div className="flex flex-col items-center">
          <div className="w-8 h-8 border-2 border-[#CC0000] border-t-transparent rounded-full animate-spin mb-3"></div>
          <p className="text-sm text-[#171717]/60 font-sans">프로필 정보를 불러오는 중...</p>
        </div>
      </div>
    );
  }
  ...
  if (!profile) {
    return (
      <div className="w-full max-w-md relative shadow-2xl shadow-black/5 h-full bg-[#FAFAFA] flex items-center justify-center">
        <div className="flex flex-col items-center">
          <p className="text-sm text-[#171717]/60 font-sans">프로필을 찾을 수 없습니다.</p>
          <button
            onClick={onBack}
            className="mt-4 px-4 py-2 bg-[#171717] text-white rounded-lg text-sm font-sans"
          >
            돌아가기
          </button>
        </div>
  ...
  if (selectedBook) {
    return (
      <div className="w-full max-w-md relative shadow-2xl shadow-black/5 h-full bg-[#FAFAFA] flex flex-col">
        {/* Header */}
        <div className="sticky top-0 z-50 bg-[#FAFAFA]/95 backdrop-blur-sm border-b border-[#171717]/10">
          <div className="flex items-center gap-3 px-6 py-4">
            ...
            <h1 className="font-sans text-base text-[#171717]">책 감상문</h1>
          </div>
        </div>
        ...
        <div className="flex-1 overflow-y-auto pb-32">
          <div className="px-6 py-8 space-y-6">
            ...
            <div className="flex gap-4 items-start">
              <div className="w-24 h-36 flex-shrink-0 rounded-lg overflow-hidden border border-[#171717]/10 shadow-lg">
                <ImageWithFallback
              ...
              <div className="flex-1">
                <h2 className="font-serif text-xl text-[#171717] mb-2">{selectedBook.title}</h2>
                <p className="text-sm text-[#171717]/60 font-sans mb-4">{selectedBook.author}</p>
              </div>
            </div>

            {/* Review */}
            <div className="bg-white border border-[#C2C2C2]/60 rounded-xl p-6 shadow-sm relative overflow-hidden">
              <div
              ...
              <div className="relative z-10 font-serif text-[#171717] leading-relaxed whitespace-pre-wrap break-words">
                {selectedBook.review}
              </div>
            </div>
            ...
            {!disableMatching && isRequestSent && existingRequest && (
              <div>
                <div className="flex items-start gap-3 bg-gradient-to-br from-[#CC0000]/10 to-[#CC0000]/5 border border-[#CC0000]/30 rounded-lg p-4 mb-3">
                  <Heart className="w-5 h-5 text-[#CC0000] flex-shrink-0 mt-0.5" />
                  <div className="flex-1">
                    <p className="text-sm text-[#171717] font-sans font-medium mb-2">
                      내가 보낸 편지
                    </p>
                    <div className="bg-white/60 rounded-lg p-3 border border-[#CC0000]/20">
                      <p className="font-serif text-sm text-[#171717] leading-relaxed whitespace-pre-wrap break-words">
                        {existingRequest.letter}
                      </p>
                    </div>
                    <p className="text-xs text-[#171717]/50 font-sans mt-2">
  ...
  return (
    <div className="w-full max-w-md relative shadow-2xl shadow-black/5 h-full bg-[#FAFAFA] flex flex-col">
      {/* Top Navigation */}
      <div className="relative z-10 bg-[#FAFAFA]/95 backdrop-blur-sm border-b border-[#171717]/10">
        <div className="flex items-center gap-3 px-6 py-4">
          <button
            onClick={onBack}
            className="p-1 hover:bg-[#171717]/5 rounded-full transition-colors"
          ...
          <h1 className="font-sans text-base text-[#171717]">상대프로필</h1>
        </div>
      </div>
      ...
      <div ref={scrollContainerRef} className="flex-1 overflow-y-auto pb-32">
        ...
        <div className="px-6 py-4 border-b border-[#171717]/10">
          <div className="grid grid-cols-4 gap-2">
            <div className="bg-white border border-[#171717]/10 rounded-lg p-3 text-center">
              <p className="text-xs text-[#171717]/50 font-sans mb-1">종교</p>
              <p className="text-sm text-[#171717] font-sans font-medium">
                {getReligionText(profile.religion)}
              </p>
            </div>
            <div className="bg-white border border-[#171717]/10 rounded-lg p-3 text-center">
              <p className="text-xs text-[#171717]/50 font-sans mb-1">키</p>
              <p className="text-sm text-[#171717] font-sans font-medium">{profile.height}</p>
            </div>
            <div className="bg-white border border-[#171717]/10 rounded-lg p-3 text-center">
              <p className="text-xs text-[#171717]/50 font-sans mb-1">흡연</p>
              <p className="text-sm text-[#171717] font-sans font-medium">
                {getSmokingText(profile.smoking)}
              </p>
            </div>
            <div className="bg-white border border-[#171717]/10 rounded-lg p-3 text-center">
              <p className="text-xs text-[#171717]/50 font-sans mb-1">음주</p>
              <p className="text-sm text-[#171717] font-sans font-medium">
        ...
        {/* Bio Section */}
        <div className="px-6 py-6 border-b border-[#171717]/10">
          <h3 className="font-sans text-sm text-[#171717]/60 mb-2">자기소개</h3>
          <p className="text-[#171717] font-sans leading-relaxed">{profile.bio}</p>
        </div>
        ...
        <div className="px-6 py-8">
          <div className="flex items-center gap-2 mb-6">
            ...
            <h3 className="font-serif text-xl text-[#171717]">나의 책장 {profile.books.length}권</h3>
            <div className="h-px flex-1 bg-[#CC0000]/20 ml-2" />
          </div>
          ...
          <div className="grid grid-cols-3 gap-4 mb-6">
            {profile.books.map((book) => (
              <button
                ...
                className="group relative aspect-[2/3] rounded-lg overflow-hidden border border-[#171717]/10 shadow-md hover:shadow-xl hover:scale-105 transition-all duration-300"
              >
                <ImageWithFallback
                  src={book.cover}
                  alt={book.title}
          ...
          {!disableMatching && !isRequestSent && (
            <div className="flex items-start gap-3 bg-[#F0F0F0] border border-[#C2C2C2]/80 rounded-lg p-4">
              <Heart className="w-5 h-5 text-[#CC0000] flex-shrink-0 mt-0.5" />
              <div>
                <p className="text-sm text-[#171717] font-sans leading-relaxed">
          ...
          {!disableMatching && isRequestSent && existingRequest && (
            <div>
              <div className="flex items-start gap-3 bg-[#F0F0F0] border border-[#C2C2C2]/80 rounded-lg p-4 mb-3">
                <Heart className="w-5 h-5 text-[#CC0000] flex-shrink-0 mt-0.5" />
                <div className="flex-1">
                  <p className="text-sm text-[#171717] font-sans font-medium mb-2">
                    내가 보낸 편지
                  </p>
                  <div className="bg-white rounded-lg p-3 border border-[#C2C2C2]/60">
                    <p className="font-serif text-sm text-[#171717] leading-relaxed whitespace-pre-wrap break-words">
                      {existingRequest.letter}
                    </p>
                  </div>
      ...
      {!disableMatching && !isRequestSent && (
        <div className="fixed bottom-0 left-0 right-0 bg-gradient-to-t from-white via-white to-transparent p-6 pb-8">
          <button
            ...
            className="w-full max-w-md mx-auto bg-[#CC0000] text-white font-sans font-medium py-4 rounded-xl hover:bg-[#CC0000]/90 transition-all duration-300 shadow-2xl shadow-[#CC0000]/30 flex items-center justify-center gap-2"
          >
